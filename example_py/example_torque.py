...
if __name__ == '__main__':
    ...
    while True:
        ...
        if( motiontime >= 500):
            sin_count += 1
            sin_joint1 = 0.4 * math.sin(t*freq_rad)
            desired_pos = 0.9 + sin_joint1
            #sin_count += 1
            torque = (desired_pos - state.motorState[d['RL_1']].q)*10.0 + (0 - state.motorState[d['RL_1']].dq)*1.0
            ...
            cmd.motorCmd[d['RL_0']].q = 0.0
            cmd.motorCmd[d['RL_0']].dq = 0.
            cmd.motorCmd[d['RL_0']].Kp = 20
            cmd.motorCmd[d['RL_0']].Kd = 1
            cmd.motorCmd[d['RL_0']].tau = 0.

            cmd.motorCmd[d['RR_0']].q = 0.0
            cmd.motorCmd[d['RR_0']].dq = 0.
            cmd.motorCmd[d['RR_0']].Kp = 20
            cmd.motorCmd[d['RR_0']].Kd = 1
            cmd.motorCmd[d['RR_0']].tau = 0.
            ...
            cmd.motorCmd[d['RL_1']].Kp = 0
            cmd.motorCmd[d['RL_1']].Kd = 0
            cmd.motorCmd[d['RL_1']].tau = torque

            #print(state.motorState[d['RL_1']].q)
