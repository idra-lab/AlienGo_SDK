...
if __name__ == '__main__':
    ...
    # print(dir(state.imu.quaternion))
    ...
    while True:
        ...
        #print(state.motorState[d['FR_0']].dq)
        ...
        if( motiontime >= 0):
            ...
            cmd.motorCmd[d['RL_0']].Kp = Kp[0]
            cmd.motorCmd[d['RL_0']].Kd = Kd[0]
            cmd.motorCmd[d['RL_0']].tau = -1.6

            cmd.motorCmd[d['RL_1']].q = qDes[10]
            cmd.motorCmd[d['RL_1']].dq = 0
            cmd.motorCmd[d['RL_1']].Kp = Kp[1]
            cmd.motorCmd[d['RL_1']].Kd = Kd[1]
            cmd.motorCmd[d['RL_1']].tau = 0.0

            cmd.motorCmd[d['RL_2']].q =  qDes[11]
            cmd.motorCmd[d['RL_2']].dq = 0
            cmd.motorCmd[d['RL_2']].Kp = Kp[2]
            cmd.motorCmd[d['RL_2']].Kd = Kd[2]
